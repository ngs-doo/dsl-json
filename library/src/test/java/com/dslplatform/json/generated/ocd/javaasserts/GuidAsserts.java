...
public class GuidAsserts {
	...
	private static void assertLinkedListOfOneEquals(final String message, final List<java.util.UUID> expecteds, final List<java.util.UUID> actuals) {
		final int expectedsSize = expecteds.size();
		final int actualsSize = actuals.size();
		if (expectedsSize != actualsSize) {
	...
	private static void assertOneLinkedListOfOneEquals(final String message, final List<java.util.UUID> expecteds, final List<java.util.UUID> actuals) {
		int i = 0;
		for (final java.util.UUID expected : expecteds) {
			if (expected == null) {
				Assert.fail(message + "element mismatch occurred at index " + i + ": expected was <null> - WARNING: This is a preconditions failure in expected, this assertion will never succeed!");
	...
	public static void assertOneLinkedListOfOneEquals(final List<java.util.UUID> expecteds, final List<java.util.UUID> actuals) {
		assertOneLinkedListOfOneEquals("OneLinkedListOfOneGuid mismatch: ", expecteds, actuals);
	}

	private static void assertNullableLinkedListOfOneEquals(final String message, final List<java.util.UUID> expecteds, final List<java.util.UUID> actuals) {
		if (expecteds == actuals) return;
	...
	public static void assertNullableLinkedListOfOneEquals(final List<java.util.UUID> expecteds, final List<java.util.UUID> actuals) {
		assertNullableLinkedListOfOneEquals("NullableLinkedListOfOneGuid mismatch: ", expecteds, actuals);
	}

	private static void assertLinkedListOfNullableEquals(final String message, final List<java.util.UUID> expecteds, final List<java.util.UUID> actuals) {
		final int expectedsSize = expecteds.size();
		final int actualsSize = actuals.size();
		if (expectedsSize != actualsSize) {
			Assert.fail(message + "expecteds was a linked list of size " + expectedsSize + ", but actuals was a linked list of size " + actualsSize);
	...
	private static void assertOneLinkedListOfNullableEquals(final String message, final List<java.util.UUID> expecteds, final List<java.util.UUID> actuals) {
		if (expecteds == null) Assert.fail(message + "expecteds was <null> - WARNING: This is a preconditions failure in expecteds, this assertion will never succeed!");
		if (expecteds == actuals) return;
		if (actuals == null) Assert.fail(message + "expecteds was a linked list of size " + expecteds.size() + ", but actuals was <null>");
	...
	public static void assertOneLinkedListOfNullableEquals(final List<java.util.UUID> expecteds, final List<java.util.UUID> actuals) {
		assertOneLinkedListOfNullableEquals("OneLinkedListOfNullableGuid mismatch: ", expecteds, actuals);
	}

	private static void assertNullableLinkedListOfNullableEquals(final String message, final List<java.util.UUID> expecteds, final List<java.util.UUID> actuals) {
		if (expecteds == actuals) return;
		if (expecteds == null) Assert.fail(message + "expecteds was <null>, but actuals was a linked list of size " + actuals.size());
		if (actuals == null) Assert.fail(message + " expecteds was a linked list of size " + expecteds.size() + ", but actuals was <null>");
		assertLinkedListOfNullableEquals(message, expecteds, actuals);
	...
	public static void assertNullableLinkedListOfNullableEquals(final List<java.util.UUID> expecteds, final List<java.util.UUID> actuals) {
