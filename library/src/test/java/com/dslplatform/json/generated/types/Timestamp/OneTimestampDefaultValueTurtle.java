...
public class OneTimestampDefaultValueTurtle {
	...
	public void testDefaultValueEquality() throws IOException {
		...
		TimestampAsserts.assertOneEquals(defaultValue, defaultValueJsonDeserialized);
	}
	...
	public void testBorderValue1Equality() throws IOException {
		...
		TimestampAsserts.assertOneEquals(borderValue1, borderValue1JsonDeserialized);
	}
	...
	public void testBorderValue2Equality() throws IOException {
		...
		TimestampAsserts.assertOneEquals(borderValue2, borderValue2JsonDeserialized);
	}
	...
	public void testBorderValue3Equality() throws IOException {
		...
		TimestampAsserts.assertOneEquals(borderValue3, borderValue3JsonDeserialized);
	}
}
