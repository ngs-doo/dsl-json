...
public class OneListOfNullableDatesDefaultValueTurtle {
	...
	public void testDefaultValueEquality() throws IOException {
		final java.util.List<java.time.LocalDate> defaultValue = new java.util.ArrayList<java.time.LocalDate>(0);
		...
		DateAsserts.assertOneListOfNullableEquals(defaultValue, defaultValueJsonDeserialized);
	}

	@org.junit.Test
	public void testBorderValue1Equality() throws IOException {
		final java.util.List<java.time.LocalDate> borderValue1 = new java.util.ArrayList<java.time.LocalDate>(java.util.Arrays.asList((java.time.LocalDate) null));
		...
		DateAsserts.assertOneListOfNullableEquals(borderValue1, borderValue1JsonDeserialized);
	}

	@org.junit.Test
	public void testBorderValue2Equality() throws IOException {
		final java.util.List<java.time.LocalDate> borderValue2 = new java.util.ArrayList<java.time.LocalDate>(java.util.Arrays.asList(java.time.LocalDate.now()));
		...
		DateAsserts.assertOneListOfNullableEquals(borderValue2, borderValue2JsonDeserialized);
	}

	@org.junit.Test
	public void testBorderValue3Equality() throws IOException {
		final java.util.List<java.time.LocalDate> borderValue3 = new java.util.ArrayList<java.time.LocalDate>(java.util.Arrays.asList(java.time.LocalDate.of(9999, 12, 31)));
		...
		DateAsserts.assertOneListOfNullableEquals(borderValue3, borderValue3JsonDeserialized);
	}

	@org.junit.Test
	public void testBorderValue4Equality() throws IOException {
		final java.util.List<java.time.LocalDate> borderValue4 = new java.util.ArrayList<java.time.LocalDate>(java.util.Arrays.asList(java.time.LocalDate.now(), java.time.LocalDate.of(1, 2, 3), java.time.LocalDate.of(1, 1, 1), java.time.LocalDate.of(1970, 1, 1), java.time.LocalDate.of(2038, 2, 13), java.time.LocalDate.of(9999, 12, 31)));
		final StaticJsonJava.Bytes borderValue4JsonSerialized = jsonSerialization.serialize(borderValue4);
		final java.util.List<java.time.LocalDate> borderValue4JsonDeserialized = jsonSerialization.deserializeList(java.time.LocalDate.class, borderValue4JsonSerialized.content, borderValue4JsonSerialized.length);
		DateAsserts.assertOneListOfNullableEquals(borderValue4, borderValue4JsonDeserialized);
	}

	@org.junit.Test
	public void testBorderValue5Equality() throws IOException {
		final java.util.List<java.time.LocalDate> borderValue5 = new java.util.ArrayList<java.time.LocalDate>(java.util.Arrays.asList((java.time.LocalDate) null, java.time.LocalDate.now(), java.time.LocalDate.of(1, 2, 3), java.time.LocalDate.of(1, 1, 1), java.time.LocalDate.of(1970, 1, 1), java.time.LocalDate.of(2038, 2, 13), java.time.LocalDate.of(9999, 12, 31)));
		final StaticJsonJava.Bytes borderValue5JsonSerialized = jsonSerialization.serialize(borderValue5);
		final java.util.List<java.time.LocalDate> borderValue5JsonDeserialized = jsonSerialization.deserializeList(java.time.LocalDate.class, borderValue5JsonSerialized.content, borderValue5JsonSerialized.length);
		DateAsserts.assertOneListOfNullableEquals(borderValue5, borderValue5JsonDeserialized);
	}
}
