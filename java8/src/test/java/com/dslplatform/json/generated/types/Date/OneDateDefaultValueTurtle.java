...
public class OneDateDefaultValueTurtle {
	...
	public void testDefaultValueEquality() throws IOException {
		final java.time.LocalDate defaultValue = java.time.LocalDate.now();
	...
	public void testBorderValue1Equality() throws IOException {
		final java.time.LocalDate borderValue1 = java.time.LocalDate.of(1, 2, 3);
	...
	public void testBorderValue2Equality() throws IOException {
		final java.time.LocalDate borderValue2 = java.time.LocalDate.of(1, 1, 1);
	...
	public void testBorderValue3Equality() throws IOException {
		final java.time.LocalDate borderValue3 = java.time.LocalDate.of(1970, 1, 1);
	...
	public void testBorderValue4Equality() throws IOException {
		final java.time.LocalDate borderValue4 = java.time.LocalDate.of(2038, 2, 13);
	...
	public void testBorderValue5Equality() throws IOException {
		final java.time.LocalDate borderValue5 = java.time.LocalDate.of(9999, 12, 31);
