...
public class NestedCollection {
	...
	public void testResolution() throws IOException {
		...
		wo.colColLong = Arrays.asList(Arrays.asList(1L, 2L), new ArrayList<>(), null, Collections.singletonList(3L));
		wo.colColUnknown = Arrays.asList(Arrays.asList(true, "one"), new ArrayList<>(), null, Collections.singletonList("3"));
		wo.colColSelf = Arrays.asList(null, new ArrayList<>());
	...
	public void testGeneric() throws IOException {
		...
		wo.colColT = Arrays.asList(Arrays.asList(1L, 2L), new ArrayList<>(), null, Collections.singletonList(3L));
		ByteArrayOutputStream baos = new ByteArrayOutputStream();
		json.serialize(wo, baos);
		ByteArrayInputStream bais = new ByteArrayInputStream(baos.toByteArray());
