...
For use in Android, Gradle can be configured with:
    ...
    dependencies {
      compile 'com.dslplatform:dsl-json-java8:1.9.2'
      annotationProcessor 'com.dslplatform:dsl-json-java8:1.9.2'
...
For use in Android, Gradle can be configured with:
    ...
    dependencies {
      compile 'com.dslplatform:dsl-json:1.9.2'
      annotationProcessor 'com.dslplatform:dsl-json-processor:1.9.2'
    }
...
For SBT dependency can be added as:
    ...
    libraryDependencies += "com.dslplatform" %% "dsl-json-scala" % "1.9.2"
...
When used with Gradle, configuration can be done via:
    ...
    dependencies {
      compile "com.dslplatform:dsl-json-java8:1.9.2"
      kapt "com.dslplatform:dsl-json-java8:1.9.2"
    }
