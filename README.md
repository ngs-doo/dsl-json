...
For use in Android, Gradle can be configured with:
    ...
    dependencies {
      compile 'com.dslplatform:dsl-json:1.8.2'
      annotationProcessor 'com.dslplatform:dsl-json-processor:1.8.2'
    }
...
For SBT dependency can be added as:
    ...
    libraryDependencies += "com.dslplatform" %% "dsl-json-scala" % "1.8.2"
