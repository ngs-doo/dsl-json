package com.dslplatform.runtime;
...
public class Example {
	...
	public static void main(String[] args) throws IOException {
		...
		DslJson.Settings settings =
				Settings.withRuntime() //Runtime configuration needs to be explicitly enabled
